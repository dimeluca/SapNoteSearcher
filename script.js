...
var sap_note_desc_url_1 = "https://me.sap.com/servicessupport/search/%7B%22q%22%3A%22"
var sap_note_desc_url_2 = "%22%2C%22originContext%22%3A%22CentralSearch%22%7D"
...
function searchNote(){
	if(document.getElementById('form2').value.length == 0){
		...
		var final_url = sap_note_desc_url_1 + document.getElementById('form2').value + sap_note_desc_url_2
		window.open(final_url, '_blank').focus();
	}
}